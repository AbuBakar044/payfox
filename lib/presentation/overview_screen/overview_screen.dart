...
class OverviewScreen extends GetWidget<OverviewController> {
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      CustomDropDown(
                        ...
                        items: controller
                            .overviewModelObj.value.dropdownItemList!.value,
                ...
                SizedBox(height: 8.v),
                _buildPriceColumn(
                  priceProp: "lbl_120_923".tr,
                  totalEarnedProp: "msg_successful_transactions".tr,
                ),
                SizedBox(height: 7.v),
                _buildPriceColumn(
                  priceProp: "lbl_467_573".tr,
                  totalEarnedProp: "lbl_total_earned".tr,
                ),
                SizedBox(height: 7.v),
              ],
            ),
  ...
  Widget _buildPriceColumn({
    required String priceProp,
    required String totalEarnedProp,
  }) {
    return Container(
      padding: EdgeInsets.symmetric(
        horizontal: 37.h,
