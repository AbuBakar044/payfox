import '../inventory_screen/widgets/userprofile12_item_widget.dart';
          ...
          child: Obx(
            () => ListView.separated(
              ...
              itemCount: controller
                  .inventoryModelObj.value.userprofile12ItemList.value.length,
              itemBuilder: (context, index) {
                Userprofile12ItemModel model = controller
                    .inventoryModelObj.value.userprofile12ItemList.value[index];
